...
document.getElementById('add').addEventListener('click', () => {
    ...
    //Mood attempt 6--Success!
    let moodRadio = document.getElementsByName('moodRadio');
    ...
    //Topic attempt 4--Success!
    let topicCheckbox = document.getElementsByName('topicCheckbox');
    let topicCheckboxValue = "";
    ...
    row.insertCell(2).innerHTML = tcv;

    //Emotions attempt 2--Success!
    let emotionsCheckbox = document.getElementsByName('emotionsCheckbox');
    let emotionsCheckboxValue = "";
    ...
    row.insertCell(3).innerHTML = ecv;

    //Thoughts attempt 1--Success!
    row.insertCell(4).innerHTML = document.getElementById('thoughts').value; //Sets value of 4th cell, under Thoughts header

    //Distortions attempt 3--Success!
    let distortionsCheckbox = document.getElementsByName('distortionsCheckbox');
    let distortionsCheckboxValue = "";
    ...
    row.insertCell(5).innerHTML = dcv;
    
    //Feelings attempt 2--
    let feelingsRadio = document.getElementsByName('feelingsRadio');
...
//Topic attempt 1--Result is "undefined", despite each topic having a corresponding value attribute
    ...
    //Distortions attempt 1
    // row.insertCell(5).innerHTML = document.getElementById('distortions').value; //Sets value of 4th cell, under Distortions header

    //Distortions attempt 2--
    // var d = document.getElementById("distortionsCheckbox1").value;
    // row.insertCell(5).innerHTML = d; //Sets value of 5th cell, under Distortions header
    // //Copy from emotions radio code
